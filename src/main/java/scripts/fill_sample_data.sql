...
INSERT INTO Users (Email, PasswordHash, PasswordSalt, UserName, FirstName, LastName, CreatedAt, UpdatedAt) VALUES
                                                                                                               ...
                                                                                                               ('driver@email.com', '$2a$12$TIvVq2oqroUVOGHRE1FZ4.mQhABSQvU4xDZSJzoAWn6mHUN4C1qty', 'a', 'driver1', 'J.', 'Knight', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO DriverName (DriverIdPGO, FirstName, LastName, UserId, FirstSeen, LastSeen) VALUES
                                                                              ...
                                                                              (20750, 'J.', 'Knight', 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO Driver (UserId, HoursClocked, Rides, DriverIDPGO) VALUES (2, 5, 15, 20750), (5, 7, 25, NULL);
...
INSERT INTO Review (UserId, DriverFirstName, DriverLastName, DriverIDPGO, Rating, Content, CreatedAt) VALUES
    ...
    (1, 'J.', 'Knight', 20750, 5, 'J. Knight review', CURRENT_TIMESTAMP),
    (4, 'J.', 'Snow', 2, 3, 'Slightly less cooler review', CURRENT_TIMESTAMP);



INSERT INTO Request (Route, Pickup, DropOff, Status, UserId, DriverId, RequestTime, AcceptTime) VALUES
    ('Campus Loop', 'School of Music', '430 Tate st', 'pending', 1,  1, CURRENT_TIMESTAMP, NULL);
